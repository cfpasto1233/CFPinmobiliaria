...
import { selectSolicitudesPublicarPropiedadLoading } from '../../store/SolicitudesPublicarPropiedad/solicitudes-publicar-propiedad.selectors';
...
export class PublicarPropiedadComponent {
  ...
  protected onSubmit(): void {
    ...
    this.store.dispatch(
      SolicitudesPublicarPropiedadActions.create({
        form: {
          nombre_propietario: raw.nombreCompleto ?? '',
